...
3. Minimum Incremental Motion

The user will interact with a single GUI that will take user-inputted test parameters and stage info, display errors and info, and display plots and results.
	Open TestInterface.py to run the GUI
